...
CallbackReturn RobotSystemHardware::on_init(const hardware_interface::HardwareInfo & info)
{
    ...
    {
        // 检查command_interfaces 以及 state_interfaces 的大小
        RCLCPP_INFO(
            rclcpp::get_logger("RobotSystemHardware"),
            "%zu Joint command interfaces find, %zu Joint state interfaces find.",
...
CallbackReturn RobotSystemHardware::on_configure(
...
RobotSystemHardware::export_state_interfaces()
{
...
RobotSystemHardware::export_command_interfaces()
{
...
CallbackReturn RobotSystemHardware::on_activate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
...
CallbackReturn RobotSystemHardware::on_deactivate(
  const rclcpp_lifecycle::State & /*previous_state*/)
{
  // START: This part here is for exemplary purposes - Please do not copy to your production code
  RCLCPP_INFO(
