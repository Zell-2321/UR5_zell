...
def generate_launch_description() -> LaunchDescription:
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            "robot_controller",
            default_value="ur5_arm_zell_controller",
    ...
    robot_controllers = PathJoinSubstitution(
        [
            FindPackageShare("ur5_arm_zell_controller_interface"),
            "config",
            "robot_controllers_custom.yaml",
        ]
    )
    ...
    ) # 如果启动了这个节点，则 description包中ur5_control-gazebo中不需要再次声明插件，否则会出现
